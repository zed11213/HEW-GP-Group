...
static int g_Tex1_moon;
static int g_Tex2_clouds;
static int g_Tex3_bg_mountains;
...
void InitBackGround(void)
{
	...
	g_Tex1_moon = LoadTexture((char*)"data/TEXTURE/1_moon.png");
	g_Tex2_clouds = LoadTexture((char*)"data/TEXTURE/2_clouds.png");
	g_Tex3_bg_mountains = LoadTexture((char*)"data/TEXTURE/3_bg_mountains.png");
	g_Tex4_ground = LoadTexture((char*)"data/TEXTURE/4_ground.png");
	g_Tex5_fg_bush = LoadTexture((char*)"data/TEXTURE/5_fg_bush.png");
	g_Tex6_fg = LoadTexture((char*)"data/TEXTURE/6_fg.png");
	...
	SetBackGround(g_Tex1_moon, 1);
	SetBackGround(g_Tex2_clouds, 2);
	SetBackGround(g_Tex3_bg_mountains, 3, 0.15f);
	SetBackGround(g_Tex4_ground, 4, 0.20f);
	SetBackGround(g_Tex5_fg_bush, 5, 0.25f);
	SetBackGround(g_Tex6_fg, 6, 0.30f);
}
