...
bool GetKeyboardRepeat(int nKey);//押しっぱなしで連続検知
bool GetKeyboardRelease(int nKey);//離すと検知
...
float GetMouseAbsoluteX(void);		// ウィンドウ上のマウスの座標X
float GetMouseAbsoluteY(void);		// ウィンドウ上のマウスの座標Y
float GetMouseAbsoluteXCamera(void); // ウィンドウ上のマウスの座標X(カメラ座標補正あり)
float GetMouseAbsoluteYCamera(void); // ウィンドウ上のマウスの座標Y(カメラ座標補正あり)
