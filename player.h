...
#define PLAYER_HITBOX_WIDTH		(DEFAULT_TILE_SIZE * 0.5f)//プレイヤーのヒットボックス横
#define PLAYER_HITBOX_HEIGHT	(DEFAULT_TILE_SIZE)//プレイヤーのヒットボックス縦
#define PLAYER_WIDTH_PATTERN	(4)//横アニメパターン数
#define PLAYER_HEIGHT_PATTERN	(6)//縦アニメパターン数
